...
public class Sender2 extends Thread {
	...
	Logger l;
	public Sender2(SocketAddress dest, DatagramPacket p, FinishedSending f) {
		l = new Logger();
		onFinish = f;
		try {
	...
	public Sender2(SocketAddress dest, String message, String recipient, String sender, FinishedSending f) {
		l = new Logger();
